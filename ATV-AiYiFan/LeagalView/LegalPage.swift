...
struct LegalPage: View {
    ...
    private let legalSections: [String: String] = [
        ...
        "2. 版权声明": """
            ...
            2.4 如果您是版权所有者，认为懒人影视上展示或链接的内容侵犯了您的权利，请通过 [在此处提供有效的版权投诉联系方式，例如专用邮箱 address@copyright.lazyvideo.com] 与我们联系。 我们将在收到符合法律要求的有效通知后，尽快移除或屏蔽相关链接。请提供充分的权属证明和侵权材料具体信息。
            """,
    ...
    var body: some View {
        ScrollView {
            ...
            .padding()
            .frame(maxWidth: 800) // Limit max width on larger screens
        }
